...
criaBordas = function(){
	...
	$('.mnav,.popSearch, .carrinho .ficha, body.login .half,  .acessorios, .resultadoAcessorios, .detalhesProduto, .fotoProduto, .garantiaEstendida .infoGarantia, .tags, .consumidores, .sku .area1-1-3-2, .compreJunto,.wrapperCarrinhoResumo, .checkoutPassos li.passo, .sku .area1-1-2, .parcelamento .tabsCont, .carrinhoVazio, .finaliza, .npedido').bordas();
