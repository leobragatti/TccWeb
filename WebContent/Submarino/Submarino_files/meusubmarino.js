...
LoginSuba.prototype.redirectSearchedTagNotCooked = function( condition, anchor ) {
	var ciInfo = this.loginCM.getCookieInfo("CI");
	if (ciInfo == null || ciInfo == "" || ciInfo == "999848 P 1") {
		window.document.location=SUBMARINO_LOGIN_URL + SUBMARINO_MEU + document.location.pathname + "?" + condition + "#" + anchor;
	}
};
...
MeuSuba.prototype.loadAllPersonalization = function(callbackFunction) {
	...
	// não personalizado, chama via ajax
	if (this.cookie == null) {
