...
<script type="text/javascript" src="./Submarino_files/common.ashx"></script>

	<script type="text/javascript" src="./Submarino_files/br.com.submarino.CheckOut.Web.CustomerInfo,br.com.submarino.CheckOut.Web.ashx"></script>

	<link rel="stylesheet" type="text/css" href="./Submarino_files/components.css"><!--[if lte IE 7]><link type="text/css" rel="stylesheet" media="screen" href="https://www2.submarino.com.br/images/img/skins/catalogo/css/components_IE.css"><![endif]--><link type="text/css" rel="stylesheet" href="./Submarino_files/skeleton_wide.css" media="screen"><!--[if lte IE 7]><link type="text/css" rel="stylesheet" media="screen" href="https://www2.submarino.com.br/images/img/skins/checkout/css/skeleton_wide_IE.css"><![endif]--><link rel="stylesheet" type="text/css" href="./Submarino_files/components(1).css"><!--[if lte IE 7]><link type="text/css" rel="stylesheet" media="screen" href="https://www2.submarino.com.br/images/img/skins/checkout/css/components_IE.css"><![endif]--><link rel="stylesheet" type="text/css" href="./Submarino_files/components(2).css"><!--[if lte IE 7]><link rel="stylesheet" type="text/css" href="https://www2.submarino.com.br/images/img/skins/oneclick/css/components_IE.css" /><![endif]-->

	<script type="text/javascript" src="./Submarino_files/br.com.submarino.CheckOut.Web.Controls.ucCustomerAddress,br.com.submarino.CheckOut.Web.Controls.ashx"></script>


			<div id="page" class="checkout"><a id="skipNav" href="https://www2.submarino.com.br/CustomerInfo.aspx?Email=caracalho@c.com&ZipCode=11111-222&ReturnUrl=/MYACCOUNT/DEFAULT.ASPX#content">Ir direto para o conteúdo</a>
<div id="header">
	<iframe id="iframeTop" src="./Submarino_files/FrameTop.html" width="100%" height="124" scrolling="no" frameborder="0"></iframe>
</div>
<div id="content" class="customerInfo"><div id="area1"><div id="area1A"><div id="area1B"><div id="area1C"><div id="area11">


<br>
			<table id="htbForm" cellspacing="3" width="95%" align="center" border="0">
	<tbody><tr>
		<td class="text">Para ser um cliente (pessoa Física ou Jurídica), é necessário 
							preencher corretamente o formulário abaixo com os respectivos dados cadastrais.<br>
							<strong>Atenção:</strong> os campos em <strong>NEGRITO</strong> são de 
							preenchimento obrigatório e essenciais para processarmos o envio do seu futuro 
							pedido.
						</td>
	</tr>
	<tr>
		<td><br>
							...
							<br>
							<img id="imaMeuCadastro" src="./Submarino_files/tit_meu_cadastro.gif" alt="" border="0"><br>
							<table id="htbMeuCadastro" cellspacing="0" cellpadding="0" width="100%" bgcolor="#f7f7f7" border="0">
			<tbody><tr>
				<td width="0"><img id="imaCadCornerAI" src="./Submarino_files/cad_corner_a.gif" alt="" border="0"></td>
				<td width="100%"><img id="imaSpacerTransI" src="./Submarino_files/spacer_trans.gif" alt="" border="0"></td>
				<td width="0"><img id="imaCadCornerBI" src="./Submarino_files/cad_corner_b.gif" alt="" border="0"></td>
			</tr>
			<tr>
				<td colspan="3">
...
<table class="text" cellspacing="5" width="100%" border="0">
	<tbody><tr>
		<td colspan="2">
			<div style="PADDING-LEFT: 50px"><img id="ucCustomerInfo_imaSetaSelecione" src="./Submarino_files/seta_selecione.gif" alt="" border="0">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<span class="text"><b><input id="ucCustomerInfo_rbtFisica" type="radio" name="ucCustomerInfo:CustomerType" value="rbtFisica" checked="checked" onclick="__doPostBack(&#39;ucCustomerInfo$rbtFisica&#39;,&#39;&#39;)" language="javascript"><label for="ucCustomerInfo_rbtFisica">PESSOA FÍSICA</label></b></span>
				<span class="text"><b><input id="ucCustomerInfo_rbtJuridica" type="radio" name="ucCustomerInfo:CustomerType" value="rbtJuridica" onclick="__doPostBack(&#39;ucCustomerInfo$rbtJuridica&#39;,&#39;&#39;)" language="javascript"><label for="ucCustomerInfo_rbtJuridica">PESSOA JURÍDICA</label></b></span>
			</div>
		</td>
	</tr>
	<!-- Início tr pessoa Física -->
	<tr id="ucCustomerInfo_htrFisica" style="display:;">
					<td colspan="2">
			<table class="text" width="100%" border="0">
				<tbody><tr>
					<td align="right" width="30%">Gostaria de ser chamado de:</td>
					<td width="70%"><input name="ucCustomerInfo:tbxNickName" type="text" maxlength="30" size="30" id="ucCustomerInfo_tbxNickName" class="text" onkeydown="return ClickOff(this,event);"></td>
				</tr>
				<tr>
					<td align="right" width="30%"><strong>Primeiro Nome:</strong></td>
					<td width="70%"><input name="ucCustomerInfo:tbxFirstName" type="text" maxlength="30" size="30" id="ucCustomerInfo_tbxFirstName" class="text" onkeydown="return ClickOff(this,event);" value="<%=ret.get(0) %>" ></td>
				</tr>
				<tr>
					<td align="right" width="30%"><strong>Sobrenome:</strong></td>
					<td width="70%"><input name="ucCustomerInfo:tbxLastName" type="text" maxlength="50" size="30" id="ucCustomerInfo_tbxLastName" class="text" onkeydown="return ClickOff(this,event);"></td>
				</tr>
				<tr>
					<td valign="top" align="right" width="30%"><strong>C.P.F.:</strong></td>
					<td class="text" width="70%"><input name="ucCustomerInfo:tbxCPF" type="text" maxlength="40" size="20" id="ucCustomerInfo_tbxCPF" class="text" onkeydown="return ClickOff(this,event);" value="<%=ret.get(2) %>" >
						*Obrigatório para entrega no Brasil.
						
						</td>
				</tr>
				<tr>
					<td valign="top" align="right" width="30%">R.G.:</td>
					<td class="text" width="70%"><input name="ucCustomerInfo:tbxRG" type="text" maxlength="20" size="20" id="ucCustomerInfo_tbxRG" class="text" onkeydown="return ClickOff(this,event);" value="<%=ret.get(1) %>" ></td>
				</tr>
				<tr>
					<td align="right" width="30%"><b>Data de Nascimento:</b></td>
					<td class="text" width="70%"><input name="ucCustomerInfo:tbxBornDay" type="text" maxlength="2" size="2" id="ucCustomerInfo_tbxBornDay" class="text" onkeydown="return ClickOff(this,event);"><input name="ucCustomerInfo:tbxBornMonth" type="text" maxlength="2" size="2" id="ucCustomerInfo_tbxBornMonth" class="text" onkeydown="return ClickOff(this,event);"><input name="ucCustomerInfo:tbxBornYear" type="text" maxlength="4" size="4" id="ucCustomerInfo_tbxBornYear" class="text" onkeydown="return ClickOff(this,event);">&nbsp;(dd/mm/aaaa)
						
						</td>
				</tr>
				<tr>
					<td align="right" width="30%"><strong>Sexo:</strong></td>
					<td width="70%"><select name="ucCustomerInfo:ddlGender" id="ucCustomerInfo_ddlGender" class="text">
	...
	<!-- FIM tr pessoa Física -->
	<!-- Início tr pessoa jurídica -->
	<tr id="ucCustomerInfo_htrJuridica" style="display:none;">
					<td colspan="2">
			<table id="ucCustomerInfo_htbImportant" class="text" style="BACKGROUND-POSITION: 50px 0px; BACKGROUND-IMAGE: url(https://www2.submarino.com.br/images/img/seta_importante.gif); BACKGROUND-REPEAT: no-repeat" width="100%" border="0">
						<tbody><tr>
							<td colspan="2"><img id="ucCustomerInfo_imaSpacerTransII" src="./Submarino_files/spacer_trans.gif" alt="" border="0" height="40" width="1"></td>
						</tr>
						<tr>
							<td align="right" width="30%"><strong>Razão Social:</strong></td>
							<td width="70%"><input name="ucCustomerInfo:tbxCompanyName" type="text" maxlength="30" size="50" id="ucCustomerInfo_tbxCompanyName" class="text" onkeydown="return ClickOff(this,event);"></td>
						</tr>
						<tr>
							<td align="right" width="30%"><strong>Nome de Contato:</strong></td>
							<td width="70%"><input name="ucCustomerInfo:tbxContactName" type="text" maxlength="50" size="40" id="ucCustomerInfo_tbxContactName" class="text" onkeydown="return ClickOff(this,event);"></td>
						</tr>
						<tr>
							<td valign="top" align="right" width="30%"><strong>C.N.P.J.:</strong></td>
							<td class="text" width="70%"><input name="ucCustomerInfo:tbxCNPJ" type="text" maxlength="40" size="20" id="ucCustomerInfo_tbxCNPJ" class="text" onkeydown="return ClickOff(this,event);">&nbsp;*Obrigatório 
						para entrega no Brasil.
						
						</td>
						</tr>
						<tr>
							<td valign="top" align="right" width="30%"><strong>I.E.:</strong></td>
							<td class="text" width="70%"><input name="ucCustomerInfo:tbxIE" type="text" maxlength="20" size="20" id="ucCustomerInfo_tbxIE" class="text" onkeydown="return ClickOff(this,event);" style="background:silver;">&nbsp;
						<input id="ucCustomerInfo_cbxIsento" type="checkbox" name="ucCustomerInfo:cbxIsento" checked="checked" onclick="fEnableDisableIsento( this.checked, &#39;ucCustomerInfo_tbxIE&#39;);"><label for="ucCustomerInfo_cbxIsento">&nbsp;I.E. Isento</label>
						</td>
						</tr>
					</tbody></table>
	...
	<tr>
		<td align="right" width="30%"><strong>E-mail:</strong></td>
		<td class="text" width="70%"><span id="ucCustomerInfo_lblEmail"><%=ret.get(4) %></span>&nbsp;</td>
	</tr>
	<!-- FIM tr pessoa jurídica -->
	<!-- inicio tr senha -->
	<tr id="ucCustomerInfo_htrPassword">
					<td colspan="2" style="HEIGHT: 26px">
			
<table class="text" width="100%">
	<tbody><tr>
		<td align="right" width="30%"><strong>Senha:</strong></td>
		<td class="text" width="70%"><input name="ucCustomerInfo:ucCustomerPassword:tbxPassword" type="password" maxlength="20" size="20" id="ucCustomerInfo_ucCustomerPassword_tbxPassword" class="text" onkeydown="return ClickOff(this,event);">&nbsp;(No 
			mínimo 6 caracteres e no máximo 20 caracteres)
			
			
		</td>
	</tr>
	<tr>
		<td align="right" width="30%"><strong>Repita a Senha:</strong></td>
		<td width="70%"><input name="ucCustomerInfo:ucCustomerPassword:tbxPasswordConfirm" type="password" maxlength="20" size="20" id="ucCustomerInfo_ucCustomerPassword_tbxPasswordConfirm" class="text" onkeydown="return ClickOff(this,event);"></td>
	</tr>
</tbody></table>
		</td>
				</tr>
	...
	<!-- fim tr senha-->
	<!-- tr com checkbox de promoção -->
	<tr>
		<td colspan="2"><br>
			<strong>Submarino Direto: garanta 
					seu acesso aos maiores descontos do site.</strong><br>O Submarino Direto traz em seu e-mail as 
      maiores ofertas e promoções que acontecem em todo o site. Através dele 
      você tem acesso a descontos exclusivos, que não encontraria ao navegar 
      diretamente pelo site. Você ainda recebe o <b>Torpedo Submarino</b>, 
      sempre trazendo um dos produtos mais desejados no momento pelo menor preço 
      do mercado, com validade de apenas um dia. <br><br>Selecione a opção 
      abaixo para ter todas estas vantagens. Você só tem a ganhar. 
      <br><br>
			
			<span><b><input id="ucCustomerInfo_cbxSendPromotion" type="checkbox" name="ucCustomerInfo:cbxSendPromotion" checked="checked"></b></span>
			<span id="ucCustomerInfo_lblSendPromotion">Desejo receber os e-mails do Submarino.</span></td>
	</tr>
	<tr>
		<td>
	...
	<!-- FIM tr com checkbox de promoção -->
</tbody></table>
</td>
			</tr>
			<tr>
				<td width="0"><img id="imaCadCornerCI" src="./Submarino_files/cad_corner_c.gif" alt="" border="0"></td>
				<td width="100%"><img id="imaSpacerTransIII" src="./Submarino_files/spacer_trans.gif" alt="" border="0"></td>
				<td width="0"><img id="imaCadCornerDI" src="./Submarino_files/cad_corner_d.gif" alt="" border="0"></td>
			</tr>
		</tbody></table>
	...
	<tr>
		<td class="text"><br>
							<!-- Meu Endereço --><img id="imaTitMeuEndereco" src="./Submarino_files/tit_meu_endereco.gif" alt="" border="0"><br>
							Agora preencha o fomulário abaixo com seu endereço de entrega.<br>
							<strong>Atenção:</strong> os campos em <strong>NEGRITO</strong> são de 
							preenchimento obrigatório e essenciais para processarmos o envio do seu futuro 
							pedido. Após preencher todo o formulário, clique em "Continuar" e siga para o 
							fechamento do seu pedido onde você escolherá a forma de pagamento. Em caso de 
							dúvidas utilize nosso Ajuda Ao Vivo.
							<br>
							<br>
							<!-- Table  de endereço -->
							<table id="htbMeuEndereco" cellspacing="0" cellpadding="0" width="100%" bgcolor="#f7f7f7" border="0">
			<tbody><tr>
				<td width="0"><img id="imaCadCornerAII" src="./Submarino_files/cad_corner_a.gif" alt="" border="0"></td>
				<td width="100%"><img id="imaSpacerTransIV" src="./Submarino_files/spacer_trans.gif" alt="" border="0"></td>
				<td width="0"><img id="imaCadCornerBII" src="./Submarino_files/cad_corner_b.gif" alt="" border="0"></td>
			</tr>
			<tr>
				<td colspan="3">
<script>
	function ShowHideInternationalCode( ddlCountry, tbxInternationalCodeId ){
		var tbxInternationalCode = document.getElementById( tbxInternationalCodeId );
		tbxInternationalCode.style.display = ddlCountry.options[ ddlCountry.selectedIndex ].value == 'BR' ? 'none' : '';
	}
</script>
<input name="ucCustomerAddress:tbxCityZipValidation" id="ucCustomerAddress_tbxCityZipValidation" type="hidden" onkeydown="return ClickOff(this,event);"> <input name="ucCustomerAddress:tbxStateZipValidation" id="ucCustomerAddress_tbxStateZipValidation" type="hidden" onkeydown="return ClickOff(this,event);">
<table class="text" cellspacing="5" width="100%" border="0">
	<tbody><tr>
		<td id="ucCustomerAddress_tdCEP_L" align="right" width="30%"><img id="ucCustomerAddress_imaSetaZipCode" src="./Submarino_files/seta_cep.gif" alt="" border="0"></td>
				
		<td id="ucCustomerAddress_tdCEP_R" width="70%"><input name="ucCustomerAddress:tbxZipCode" type="text" maxlength="10" size="10" id="ucCustomerAddress_tbxZipCode" class="text" onkeydown="return ClickOff(this,event);" onblur="fBindCep( this, &#39;ucCustomerAddress_ddlCountry&#39;, &#39;ucCustomerAddress_tbxAddress&#39;, &#39;ucCustomerAddress_tbxCityRegion&#39;, &#39;ucCustomerAddress_tbxCity&#39;, &#39;ucCustomerAddress_ddlState&#39;, &#39;ucCustomerAddress_tbxAddressNumber&#39;, &#39;ucCustomerAddress_tbxAddrComplement&#39;, &#39;ucCustomerAddress_tbxCityZipValidation&#39;, &#39;ucCustomerAddress_tbxStateZipValidation&#39;, &#39;ucCustomerAddress&#39;);">&nbsp;(Ex. 
			99999-999)&nbsp;&nbsp;&nbsp;<a id="ucCustomerAddress_hlkFindCep" class="text" href="javascript:ShowCepPopup();"><u>Não sabe o 
					seu CEP? Consulte aqui</u></a>
	...
	<tr>
		<td id="ucCustomerAddress_tdAddressType_L" align="right" width="30%"><strong>Tipo de 
				Endereço:</strong></td>
				
		<td id="ucCustomerAddress_tdAddressType_R" width="70%"><select name="ucCustomerAddress:ddlAddressType" id="ucCustomerAddress_ddlAddressType" class="text">
	...
	<tr>
		<td valign="top" align="right" width="30%"><strong>Endereço:</strong></td>
		<td class="text" valign="top" width="70%"><input name="ucCustomerAddress:tbxAddress" type="text" maxlength="100" size="30" id="ucCustomerAddress_tbxAddress" class="text" onkeydown="return ClickOff(this,event);"><b>n.º </b>
			<input name="ucCustomerAddress:tbxAddressNumber" type="text" maxlength="5" size="5" id="ucCustomerAddress_tbxAddressNumber" class="text" onkeydown="return ClickOff(this,event);">&nbsp;<span class="text"><b id="ucCustomerAddress_bAddress">Dúvidas 
					para o preenchimento do Endereço,&nbsp;
					<a id="ucCustomerAddress_hlkDistrito" href="javascript:ShowCepHelpPopup('https://www2.submarino.com.br/',false);">clique aqui</a></b></span></td>
	</tr>
	<tr>
		<td class="text" align="right" width="30%">Complemento:</td>
		<td class="text" width="70%"><input name="ucCustomerAddress:tbxAddrComplement" type="text" maxlength="30" size="30" id="ucCustomerAddress_tbxAddrComplement" class="text" onkeydown="return ClickOff(this,event);">&nbsp;(Ex. ap. 1234)</td>
	</tr>
	<tr>
		<td align="right" width="30%"><strong>Bairro:</strong></td>
		<td width="70%"><input name="ucCustomerAddress:tbxCityRegion" type="text" maxlength="50" size="20" id="ucCustomerAddress_tbxCityRegion" class="text" onkeydown="return ClickOff(this,event);"></td>
	</tr>
	<tr>
	...
	<tr>
		<td align="right" width="30%"><strong>Cidade:</strong></td>
		<td width="70%"><input name="ucCustomerAddress:tbxCity" type="text" maxlength="50" size="20" id="ucCustomerAddress_tbxCity" class="text" onkeydown="return ClickOff(this,event);">
			</td>
	</tr>
	<tr>
		<td style="HEIGHT: 14px" align="right" width="30%"><strong>Estado:</strong></td>
		<td style="HEIGHT: 14px" width="70%"><select name="ucCustomerAddress:ddlState" id="ucCustomerAddress_ddlState" class="text">
		...
		<td align="right" width="30%">(Pedidos Internacionais)<br>
			Estado/Província:
		</td>
		<td width="70%"><input name="ucCustomerAddress:tbxStateProvince" type="text" maxlength="50" size="20" id="ucCustomerAddress_tbxStateProvince" class="text" onkeydown="return ClickOff(this,event);">
			
			
		</td>
	</tr>
	<tr>
		<td align="right" width="30%"><strong>País:</strong></td>
		<td width="70%">
				<select name="ucCustomerAddress:ddlCountry" id="ucCustomerAddress_ddlCountry" class="text" onchange="ShowHideInternationalCode( this, &#39;ucCustomerAddress_tbxInternationalCode&#39;)">
					...
					<option value="LT">Latin America</option>
					...
					<option value="GS">South Georgia and the South Sandwich Island</option>
	...
	<tr>
		<td align="right" width="30%"><strong>Telefone 1:</strong></td>
		<td width="70%"><input name="ucCustomerAddress:tbxInternationalCode" type="text" maxlength="10" size="5" id="ucCustomerAddress_tbxInternationalCode" class="text" onkeydown="return ClickOff(this,event);" style="display:none;"><input name="ucCustomerAddress:tbxDDDPhone1" type="text" maxlength="5" size="5" id="ucCustomerAddress_tbxDDDPhone1" class="text" onkeydown="return ClickOff(this,event);"><input name="ucCustomerAddress:tbxPhone1" type="text" maxlength="15" size="15" id="ucCustomerAddress_tbxPhone1" class="text" onkeydown="return submitOnEnterChangePW(event,&#39;imbButContinue&#39;);">&nbsp;DDD+Telefone 
			Fixo, preenchimento obrigatório.
	...
	<tr>
		<td id="ucCustomerAddress_tdPhone2_L" align="right" width="30%">Telefone 2:</td>
				
		<td id="ucCustomerAddress_tdPhone2_R" width="70%"><input name="ucCustomerAddress:tbxDDDPhone2" type="text" maxlength="5" size="5" id="ucCustomerAddress_tbxDDDPhone2" class="text" onkeydown="return ClickOff(this,event);"><input name="ucCustomerAddress:tbxPhone2" type="text" maxlength="15" size="15" id="ucCustomerAddress_tbxPhone2" class="text" onkeydown="return submitOnEnterChangePW(event,&#39;imbButContinue&#39;);"></td>
				
	</tr>
	<tr>
		<td valign="top" align="right" width="30%">Referência para entrega:
		</td>
		<td class="text" width="70%"><input name="ucCustomerAddress:tbxAddressReference" type="text" maxlength="60" size="50" id="ucCustomerAddress_tbxAddressReference" class="text" onkeydown="return submitOnEnterChangePW(event,&#39;imbButContinue&#39;);"><br>
			...
			<tr>
				<td width="0"><img id="imaCadCornerCII" src="./Submarino_files/cad_corner_c.gif" alt="" border="0"></td>
				<td width="100%"><img id="imaSpacerTransV" src="./Submarino_files/spacer_trans.gif" alt="" border="0"></td>
				<td width="0"><img id="imaCadCornerDII" src="./Submarino_files/cad_corner_d.gif" alt="" border="0"></td>
			</tr>
		</tbody></table>
		
							<!-- FIM Table de endereço --></td>
	</tr>
	<tr>
		<td align="right" colspan="3"><br>
							<input type="image" name="imbButContinue" onclick="if (typeof(Page_ClientValidate) == &#39;function&#39;) Page_ClientValidate(); " language="javascript" id="imbButContinue" src="./Submarino_files/but_continue.gif" alt="" border="0"></td>
	</tr>
</tbody></table>
 <!--fim da tblMain-->
  </div></div></div></div></div>
  <div id="footer">
    <div class="footer"></div>
		...
		<div id="divTracer"></div>		
		<iframe src="./Submarino_files/ChlebaFrameCustomer.html" frameborder="0" style="display: none" width="0" height="0">
		</iframe>
		<script language="javascript"> function SetFocus( ){ var TextBox = document.getElementById( 'ucCustomerInfo_tbxNickName'  );  TextBox.focus(); } SetFocus(); </script> 
...
<meta name="WT.cg_s" content="Cadastro">

<script type="text/javascript" src="./Submarino_files/TracerCode.js"></script><script type="text/javascript" src="./Submarino_files/wtid.js"></script>
<noscript>
&lt;IMG ALT="" BORDER="0" NAME="DCSIMG" WIDTH="1" HEIGHT="1" SRC="https://wtb.submarino.com.br/dcsi30hrszokytthjsrxoe4de_4i6h/njs.gif?dcsuri=/nojavascript&amp;amp;WT.js=No&amp;amp;WT.tv=8.0.2"&gt;
</noscript>
